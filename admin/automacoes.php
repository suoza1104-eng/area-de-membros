...
function edgePath(x1,y1,x2,y2){const gap=x2-x1;if(gap>=80){const b=Math.max(55,gap*.45);return `M ${x1} ${y1} C ${x1+b} ${y1},${x2-b} ${y2},${x2} ${y2}`}const loop=Math.max(70,Math.abs(gap)*.35),midY=(y1+y2)/2;return `M ${x1} ${y1} C ${x1+loop} ${y1},${x1+loop} ${midY},${x1} ${midY} S ${x2-loop} ${midY},${x2-loop} ${y2} S ${x2-30} ${y2},${x2} ${y2}`}
