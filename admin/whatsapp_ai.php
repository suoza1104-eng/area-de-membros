...
$notificationEventCodes = [
    'INSCRITO', 'INSCRICAO_GRATUITA', 'INSCRICAO_VITALICIA', 'ACESSO_VITALICIO_LIBERADO', 'REINSCRITO', 'PRIMEIRO_LOGIN', 'ASSISTIU_ALGUMA_AULA', 'CONCLUIU_TRILHA',
    'RETORNO_AGENDADO', 'CERT_EMITIDO', 'REENVIO_CERTIFICADO', 'CERT_SENHA_ERRADA',
    'APP_INSTALADO', 'APP_NOTIFICACOES_AUTORIZADAS', 'APP_DESINSTALADO_DETECTADO',
