...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($action === 'save_provider') {
            ...
            $r = voice_test_connection($pdo);
            $message = $r['ok'] ? 'Conexao autenticada pela Telnyx.' : 'Teste retornou HTTP ' . (int)$r['status'] . '.';
