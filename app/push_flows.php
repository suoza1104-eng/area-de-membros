...
{
    return [
        'INSCRITO' => 'Aluno inscrito',
        'INSCRICAO_GRATUITA' => 'Inscrição gratuita',
        'INSCRICAO_VITALICIA' => 'Inscrição vitalícia',
        'REINSCRITO' => 'Aluno reinscrito',
        'PRIMEIRO_LOGIN' => 'Primeiro login',
        'ASSISTIU_ALGUMA_AULA' => 'Assistiu alguma aula',
        'CONCLUIU_TRILHA' => 'Concluiu a trilha',
        'APP_INSTALADO' => 'Aplicativo instalado',
        'APP_NOTIFICACOES_AUTORIZADAS' => 'Notificações autorizadas',
        ...
        'WHATSAPP_GRUPO_ENTROU' => 'Entrou no grupo de WhatsApp',
        'WHATSAPP_GRUPO_SAIU' => 'Saiu do grupo de WhatsApp',
    ];
}
