...
function support_agent_lesson_sequence_answer(array $payload): string
{
    ...
    $msg=$prefix.'as aulas sao liberadas em sequencia. Para liberar '.$nextLabel.', assista 100% da '.$previousLabel.' e clique no botao Concluir no fim da aula, na parte de baixo, ate aparecer o status de concluido.';
