...
function automation_trigger_seed_catalog(): array
{
    return [
        ...
        ['code'=>'PAGAMENTO_APROVADO','label'=>'Pagamento aprovado','category'=>'Pagamentos','badge'=>'Pagamento','description'=>'Pagamento aprovado em qualquer gateway financeiro integrado.'],
        ['code'=>'PAGAMENTO_AGUARDANDO','label'=>'Pagamento aguardando','category'=>'Pagamentos','badge'=>'Pagamento','description'=>'Pagamento pendente, como Pix gerado, boleto emitido ou checkout aberto aguardando confirmacao.'],
        ['code'=>'PAGAMENTO_REEMBOLSADO','label'=>'Pagamento reembolsado','category'=>'Pagamentos','badge'=>'Pagamento','description'=>'Pagamento reembolsado em qualquer gateway financeiro integrado.'],
        ['code'=>'PAGAMENTO_CHARGEBACK','label'=>'Pagamento em chargeback','category'=>'Pagamentos','badge'=>'Pagamento','description'=>'Pagamento contestado ou em chargeback em qualquer gateway financeiro integrado.'],
        ['code'=>'PAGAMENTO_CANCELADO','label'=>'Pagamento cancelado/recusado','category'=>'Pagamentos','badge'=>'Pagamento','description'=>'Pagamento cancelado, expirado, recusado ou nao autorizado em qualquer gateway financeiro integrado.'],
        ['code'=>'CARRINHO_ABANDONADO','label'=>'Carrinho abandonado','category'=>'Pagamentos','badge'=>'Pagamento','description'=>'Carrinho abandonado identificado por um gateway ou checkout integrado.'],
        ['code'=>'DOM_PAGAMENTO_APROVADO','label'=>'DOM: pagamento aprovado','category'=>'Pagamentos DOM','badge'=>'DOM','description'=>'Pagamento aprovado vindo da DOM Pagamentos.'],
        ['code'=>'DOM_PAGAMENTO_AGUARDANDO','label'=>'DOM: pagamento aguardando','category'=>'Pagamentos DOM','badge'=>'DOM','description'=>'Pagamento DOM pendente, com dados de cobranca quando disponiveis.'],
        ['code'=>'DOM_PAGAMENTO_REEMBOLSADO','label'=>'DOM: pagamento reembolsado','category'=>'Pagamentos DOM','badge'=>'DOM','description'=>'Pagamento reembolsado vindo da DOM Pagamentos.'],
        ['code'=>'DOM_PAGAMENTO_CHARGEBACK','label'=>'DOM: pagamento em chargeback','category'=>'Pagamentos DOM','badge'=>'DOM','description'=>'Pagamento contestado ou em chargeback vindo da DOM Pagamentos.'],
        ['code'=>'DOM_PAGAMENTO_CANCELADO','label'=>'DOM: pagamento cancelado/recusado','category'=>'Pagamentos DOM','badge'=>'DOM','description'=>'Pagamento DOM cancelado, expirado, recusado ou nao autorizado.'],
        ['code'=>'PAGARME_PAGAMENTO_APROVADO','label'=>'Pagar.me: pagamento aprovado','category'=>'Pagamentos Pagar.me','badge'=>'Pagar.me','description'=>'Pagamento aprovado vindo do Pagar.me.'],
        ['code'=>'PAGARME_PAGAMENTO_AGUARDANDO','label'=>'Pagar.me: pagamento aguardando','category'=>'Pagamentos Pagar.me','badge'=>'Pagar.me','description'=>'Pagamento Pagar.me pendente, com Pix, boleto ou link quando disponivel.'],
        ['code'=>'PAGARME_PAGAMENTO_REEMBOLSADO','label'=>'Pagar.me: pagamento reembolsado','category'=>'Pagamentos Pagar.me','badge'=>'Pagar.me','description'=>'Pagamento reembolsado vindo do Pagar.me.'],
        ['code'=>'PAGARME_PAGAMENTO_CHARGEBACK','label'=>'Pagar.me: pagamento em chargeback','category'=>'Pagamentos Pagar.me','badge'=>'Pagar.me','description'=>'Pagamento contestado ou em chargeback vindo do Pagar.me.'],
        ['code'=>'PAGARME_PAGAMENTO_CANCELADO','label'=>'Pagar.me: pagamento cancelado/recusado','category'=>'Pagamentos Pagar.me','badge'=>'Pagar.me','description'=>'Pagamento Pagar.me cancelado, recusado ou com falha.'],
        ['code'=>'FIREPAY_PAGAMENTO_APROVADO','label'=>'Firepay: pagamento aprovado','category'=>'Pagamentos Firepay','badge'=>'Firepay','description'=>'Pagamento aprovado vindo da Firepay.'],
        ['code'=>'FIREPAY_PAGAMENTO_AGUARDANDO','label'=>'Firepay: pagamento aguardando','category'=>'Pagamentos Firepay','badge'=>'Firepay','description'=>'Pagamento Firepay pendente, com link de checkout ou cobranca quando disponivel.'],
        ['code'=>'FIREPAY_PAGAMENTO_REEMBOLSADO','label'=>'Firepay: pagamento reembolsado','category'=>'Pagamentos Firepay','badge'=>'Firepay','description'=>'Pagamento reembolsado vindo da Firepay.'],
        ['code'=>'FIREPAY_PAGAMENTO_CHARGEBACK','label'=>'Firepay: pagamento em chargeback','category'=>'Pagamentos Firepay','badge'=>'Firepay','description'=>'Pagamento contestado ou em chargeback vindo da Firepay.'],
        ['code'=>'FIREPAY_PAGAMENTO_CANCELADO','label'=>'Firepay: pagamento cancelado/recusado','category'=>'Pagamentos Firepay','badge'=>'Firepay','description'=>'Pagamento Firepay cancelado, expirado ou recusado.'],
        ['code'=>'FIREPAY_CARRINHO_ABANDONADO','label'=>'Firepay: carrinho abandonado','category'=>'Pagamentos Firepay','badge'=>'Firepay','description'=>'Carrinho abandonado vindo da Firepay.'],
