  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.99
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.3.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.3.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.3.tgz':
    resolution: {integrity: sha512-XwiOxTbDLM6bIkLPL0Qni75rw9XcMuQGIHKelnYqBIdNKgDiOdN7KPiBxLc/2SdnUL/eZkDQZ0pVt200Da4b1w==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.3.tgz}
    version: 2.7.3
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
