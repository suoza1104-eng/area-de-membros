...
function cron_manager_base_definitions(): array {
    return [
        ...
        'dom_pagamentos' => [
            ...
            'description' => 'Sincroniza vendas da DOM Pagamentos via API a cada 1 hora para cobrir webhooks perdidos.',
        ...
        'pagarme_sync' => [
            ...
            'description' => 'Sincroniza vendas do Pagar.me via API a cada 1 hora para cobrir webhooks perdidos.',
        ...
        'hotmart_sync' => [
            ...
            'description' => 'Sincroniza vendas da Hotmart via API a cada 1 hora para cobrir webhooks perdidos.',
