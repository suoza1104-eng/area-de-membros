...
run_php_cron "$DEPLOY_DIR/cron/processar_emails.php" "emails"
run_php_cron "$DEPLOY_DIR/cron/processar_torpedo_voz.php" "torpedo_voz"
run_php_cron "$DEPLOY_DIR/cron/processar_whatsapp_ai.php" "whatsapp_ai"
